    ...
    return (
        <>
            <div className="full-info-day__card">
                ...
                <p className="city-info-text"><b>temperature:</b> {Math.round(cityParams.main.temp)}&deg; - feels
                    like: {Math.round(cityParams.main.feels_like)}&deg;</p>
                <p className="city-info-text"><b>pressure:</b> {cityParams.main.pressure} millimeter of mercury</p>
                ...
                <p className="city-info-text"><b>humidity:</b> {cityParams.main.humidity}%</p>
                <p className="city-info-text"><b>visibility:</b> {cityParams.visibility} meters</p>
                <p className="city-info-text"><b>cloudiness:</b> {cityParams.clouds.all}%</p>
                <p className="city-info-text"><b>probability of precipitation:</b> {cityParams.pop}%</p>
            </div>
        </>
    )
}
